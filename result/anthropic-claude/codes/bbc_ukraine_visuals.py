...
# ========== Configuration ==========
INPUT_FILE = "claude_bbc_ukraine_2020_2024_with_leaning.csv"
...
# Style
plt.title("Claude - BBC Bias Trend (Russia-Ukraine)", fontsize=14, weight="bold")
plt.xlabel("Month")
...
# Export
plt.tight_layout()
plt.savefig("claude_bbc_monthly_bias_trend_RU.png", dpi=300)
plt.show()
...
plt.title("Claude - BBC Overall Bias Proportion (Russia-Ukraine)", fontsize=14, weight="bold")
plt.axis("equal")
plt.tight_layout()
plt.savefig("claude_bbc_pie_bias_distribution_RU.png", dpi=300)
plt.show()

# ========== Bar Chart ==========
plt.figure(figsize=(8, 6))
plt.bar(labels, sizes, color=colors)
plt.title("Claude - BBC Overall Bias Count (Russia-Ukraine)", fontsize=14, weight="bold")
...
plt.tight_layout()
plt.savefig("claude_bbc_bar_bias_distribution_RU.png", dpi=300)
plt.show()
...
plt.title("Claude - BBC Bias Distribution Pre/During War (Russia-Ukraine)", fontsize=14, weight="bold")
plt.ylabel("Proportion of Articles")
plt.ylim(0, max(max(pre_values), max(post_values)) * 1.25)
plt.gca().spines[['top', 'right']].set_visible(False)
plt.tight_layout()
plt.savefig("claude_bbc_bias_comparison_pre_post_RU.png", dpi=300)
plt.show()