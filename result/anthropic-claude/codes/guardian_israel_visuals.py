...
# ========== Configuration ==========
INPUT_FILE = "claude_guardian_israel_hamas_with_leaning.csv"
...
# Style
plt.title("Claude - Guardian Bias Trend (Hamas-Israel)", fontsize=14, weight="bold")
plt.xlabel("Month")
...
# Export
plt.tight_layout()
plt.savefig("claude_guardian_monthly_bias_trend_hamas_israel.png", dpi=300)
plt.show()
...
plt.title("Claude - Guardian Overall Bias Proportion (Hamas-Israel)", fontsize=14, weight="bold")
plt.axis("equal")
plt.tight_layout()
plt.savefig("claude_guardian_pie_bias_distribution_hamas_israel.png", dpi=300)
plt.show()

# ========== Bar Chart ==========
plt.figure(figsize=(8, 6))
plt.bar(labels, sizes, color=colors)
plt.title("Claude - Guardian Overall Bias Count (Hamas-Israel)", fontsize=14, weight="bold")
...
plt.tight_layout()
plt.savefig("claude_guardian_bar_bias_distribution_hamas_israel.png", dpi=300)
plt.show()
...
plt.title("Claude - Guardian Bias Distribution Pre/During War (Hamas-Israel)", fontsize=14, weight="bold")
plt.ylabel("Proportion of Articles")
plt.ylim(0, max(max(pre_values), max(post_values)) * 1.25)
plt.gca().spines[['top', 'right']].set_visible(False)
plt.tight_layout()
plt.savefig("claude_guardian_bias_comparison_pre_post_hamas_israel.png", dpi=300)
plt.show()